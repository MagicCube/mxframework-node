...
// Types
// =====================================================================
exports.merge = require("extend");

exports.isEmpty = function(p_value)
{
    return p_value === undefined || p_value === null;
};

exports.isEmptyString = function(p_value)
{
    return p_value === undefined || p_value === null || (typeof(p_value) === "string" && p_value.trim() === "");
};

exports.notEmpty = function(p_value)
{
    return !exports.isEmpty(p_value);
};

exports.isBoolean = function(p_value)
{
    return typeof (p_value) === "boolean";
};

exports.isString = function(p_value)
{
    return typeof (p_value) === "string";
};

exports.isNumber = function(p_value)
{
    return typeof (p_value) === "number";
};

exports.isDate = function(p_value)
{
    return exports.notEmpty(p_value) && p_value.constructor === Date;
};

exports.isArray = function(p_value)
{
    ...
    {
        return exports.notEmpty(p_value) && (typeof (p_value) === "object" && typeof (p_value.length) === "number");
    }
};

exports.isObject = function(p_value)
{
    return exports.notEmpty(p_value) && typeof (p_value) === "object";
};

exports.isPlainObject = function(p_value)
{
    return p_value && p_value.constructor === Object && {}.toString.call(p_value) === "[object Object]";
};

exports.isFunction = function(p_value)
{
    return typeof (p_value) === "function";
};

exports.isClass = function(p_value)
{
    return typeof (p_value) === "function";
};
...
// Parser
// =====================================================================
exports.parseBoolean = function(p_text)
{
    if (exports.isBoolean(p_text))
    {
        return p_text;
    }
    else if (exports.isNumber(p_text))
    {
        return p_text !== 0;
    }
    else if (exports.isString(p_text))
    {
...
var __regex_Hm = /^(\S*):(\S*)$/;
exports.parseTimeString = function(p_timeString)
{
    var value =
    {
        hours : 0,
...
exports.parseDateString = function(p_dateString)
{
    var value =
    {
        year : 1900,
...
exports.parseDate = function(p_text)
{
    if (exports.isEmpty(p_text))
    {
        return null;
    }
    if (exports.isDate(p_text))
    {
        return p_text;
    }
    ...
    if (exports.notEmpty(datePart))
    {
        dateValue = exports.parseDateString(datePart);
    }
    ...
    if (exports.notEmpty(timePart))
    {
        timeValue = exports.parseTimeString(timePart);
    }
...
String.format = function(p_string, p_args)
{
    ...
    {
        if (exports.isObject(p_args) && !exports.isArray(p_args))
        {
            groups = p_string.match(/(\{[a-z][a-z$_0-9]*\})/gi);
            if (exports.notEmpty(groups))
            {
        ...
        else if (exports.isArray(p_args))
        {
...
String.newGuid = function(p_toLowerCase, p_length)
{
    ...
    if (exports.notEmpty(p_toLowerCase))
    {
        toLowerCase = p_toLowerCase;
    }
    var length = 32;
    if (exports.notEmpty(p_length))
    {
        length = p_length;
    }
    var result = "";
...
Number.format = function(p_value, p_formatString)
{
    ...
    var string = p_value + "";
    if (exports.notEmpty(p_formatString) && p_formatString !== "")
    {
...
{
    if (exports.isFunction(p_judgeFunction))
    {
        for (var i = 0; i < this.length; i++)
        {
            var item = this[i];
...
Array.prototype.min = function(p_iterator, p_context)
{
    ...
    {
        var value;
        if (exports.isFunction(p_iterator))
        {
...
exports.format = function(p_value, p_format)
{
    if (exports.isString(p_value) && (exports.isArray(p_format) || exports.isNumber(p_format) || exports.isObject(p_format)))
    {
    ...
    else if (exports.isDate(p_value))
    {
        return Date.format(p_value, p_format);
    }
    else
    {
        return exports.notEmpty(p_value) ? p_value.toString() : "";
    }
};