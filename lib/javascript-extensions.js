...
{
    return !exports.exports.isEmpty(p_value);
};
...
{
    return exports.exports.notEmpty(p_value) && p_value.constructor === Date;
};
...
exports.isArray = function(p_value)
{
    ...
    {
        return Array.exports.isArray(p_value);
    }
    else
    {
        return exports.exports.notEmpty(p_value) && (typeof (p_value) === "object" && typeof (p_value.length) === "number");
    }
};

exports.isObject = function(p_value)
{
    return exports.exports.notEmpty(p_value) && typeof (p_value) === "object";
};
