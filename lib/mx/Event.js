...
mx.Event = function()
{
    ...
    me.fire = function(e)
    {
        if (mx.notEmpty(me.listeners) && me.listeners.length > 0)
        {
            ...
            for (i = 0; i < listeners.length; i++)
            {
                ...
                if (mx.notEmpty(_onceListeners) && _onceListeners.contains(listener))
                {
